...
namespace Dono.MiningGame.Gameplay
{
    ...
    {
        [Tooltip("Sensitivity muliplier for moveing the camera around")]
        public float LookSensitivity = 1f;

        [Tooltip("Limit to consider an input when using a triugger on a controller")]
        ...
        public Vector3 getMoveInput()
        {
            if (CanProcessInput())
            {
                ...
                // constain move input to a maximum magnitude of 1, otherwise diagonal movement might exceed the max movement speed defined
